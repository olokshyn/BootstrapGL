...
size_t cube_positions_count = sizeof(cube_positions) / sizeof(cube_positions[0]);

float light_offset = 0.0f;
...
int main()
{
    try
    {
        ...
        ShaderProgram light_shader_program("shaders/vertex_light.glsl", "shaders/fragment_light.glsl");
        ...
        PointLight point_light(glm::vec3(-0.5f,  0.0f,  0.0f),
        ...
        Material cube_material(Texture(TextureInfo("textures/container2.png"), 0),
                               Texture(TextureInfo("textures/container2_specular.png"), 1));
        ...
        app_context.main_loop(
                [&](GLFWwindow* window, float delta_time) -> bool
                {
                    ...
                    for (size_t i = 0; i != cube_positions_count; ++i)
                    {
                    ...
                    light_offset += 0.7 * delta_time;
                    point_light.position().z = 2.0f + 1.0f * static_cast<float>(cos(light_offset));
